...
public class ClientGUI extends JFrame {
	...
	public ClientGUI() {
		...
		txtpnChatRoom.setBackground(new Color(127, 255, 212));
		txtpnChatRoom.setFont(new Font("Calibri", Font.BOLD, 35));
		txtpnChatRoom.setText("CHAT ROOM");
		txtpnChatRoom.setBounds(310, 10, 193, 41);
		panel.add(txtpnChatRoom);
		
		JPanel panelclient = new JPanel();
		panelclient.setBackground(new Color(127, 255, 212));
		panelclient.setBounds(240, 5, 60, 60);
		...
		panelX.setBackground(new Color(127, 255, 212));
